...
In this chapter, you will choose **one of the following two projects** to complete.

이 장에서는 **다음 2개 프로젝트 중 1개**를 선택하여 진행합니다.

**Option 1**: Simple TODO Management System (for personal use)

**Option 2**: Simple Product Management System (for administrators)

**선택 1**: 간단한 TODO 관리 시스템 (개인용)
...
### 3-2 Login Page (login.php) (로그인 페이지)
...
### 3-4 Add TODO (add_todo.php) (TODO 추가)
...
### 3-5 TODO List (list_todos.php) (TODO 목록)
...
### 3-6 Edit TODO (edit_todo.php) (TODO 수정)
...
### 2-2 Test Data Setup (setup_users.php) (테스트 데이터 생성)
...
### 3-2 Add Product (add_product.php) (상품 추가)
...
### 3-3 Product List (list_products.php) (상품 목록)
...
### 3-4 Edit Product (edit_product.php) (상품 수정)
