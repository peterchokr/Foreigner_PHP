...
#### **Method 1: PDO (PHP Data Objects) (방식 1: PDO)**
...
#### **Method 2: MySQLi (MySQL Improved) (방식 2: MySQLi)**
...
### 3-4 fetch() vs fetchAll() (fetch() vs fetchAll())
...
### 4-1 What is SQL Injection? (SQL Injection이란?)
...
<html>
<head>
    <title>Student Information Query (학생 정보 조회)</title>
    <style>
        body {
...
<div class="container">
    <h1>📊 Student Information Query (학생 정보 조회)</h1>
  
    <!-- Search form (검색 폼) -->
    <div class="search-box">
        <form method="GET">
            <label>Minimum score: (최소 성적 이상:)</label>
    ...
    <?php else: ?>
    <p>No search results found. (검색 결과가 없습니다.)</p>
    <?php endif; ?>
</div>
