...
<div class="container">
    ...
    <h2 style="grid-column: 1 / -1; margin-top: 30px;">All Multiplication Tables</h2>
...
<div class="container">
    ...
    <div class="section">
        <h2>3️⃣ Top Students - 80+ Points</h2>
        <?php
